...
namespace I2.Loc
{
	...
	public class SetLanguageInspector : Editor
	{
		...
		public SerializedProperty mProp_index;

		public void OnEnable()
		{
			setLan = (SetLanguage)target;
			mProp_Language = serializedObject.FindProperty("_Language");
			//mProp_index = serializedObject.FindProperty("index");
		}

		public override void OnInspectorGUI()
		{
			var myScript = target as SetLanguage;
			myScript.index = EditorGUILayout.IntField("Index", myScript.index);
