...
namespace NiobiumStudios
{
    ...
    public class DailyRewardUI : MonoBehaviour
    {
        ...
        {
            textDay.text = LocalizationManager.GetTermTranslation("DAY") + " " + day.ToString();
        ...
        public void Refresh()
        {
            ...
            GetComponent<RectTransform>().localPosition = new Vector3(GetComponent<RectTransform>().localPosition.x, GetComponent<RectTransform>().localPosition.y, 0f);
        }
    }
}