...
namespace NiobiumStudios
{
    ...
    public class TimedRewardsEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            SerializedProperty minRandomTime = serializedObject.FindProperty("minRandomTime");
            SerializedProperty maxRandomTime = serializedObject.FindProperty("maxRandomTime");
            ...
            EditorGUILayout.PropertyField(minRandomTime, new GUIContent("Min Random Time", "Min Random Time in seconds for the reward countdown"));
            EditorGUILayout.PropertyField(maxRandomTime, new GUIContent("Max Random Time", "Max Random Time in seconds for the reward countdown"));
