...
namespace NiobiumStudios
{
    ...
    **/
    public class DailyRewards : DailyRewardsCore<DailyRewards>
    {
        ...
        {
            int debugHours = EncryptedPlayerPrefs.GetInt(GetDebugTimeKey(), 0);
        ...
        {
            string lastClaimedTimeStr = EncryptedPlayerPrefs.GetString(GetLastRewardTimeKey());
            lastReward = EncryptedPlayerPrefs.GetInt(GetLastRewardKey());
        ...
        public void ClaimPrize()
        {
            if (availableReward > 0)
            {
                ...
                DailyRewardsInterface.instance.coinsReward.Play();
                Debug.Log("ID " + instanceId + " Reward [" + rewards[availableReward - 1] + "] Claimed!");
                EncryptedPlayerPrefs.SetInt(GetLastRewardKey(), availableReward);
                ...
                EncryptedPlayerPrefs.SetString(GetLastRewardTimeKey(), lastClaimedStr);
                EncryptedPlayerPrefs.SetInt(GetDebugTimeKey(), (int)debugTime.TotalHours);
            }
        ...
        //Returns the lastReward EncryptedPlayerPrefs key depending on instanceId
        ...
        //Returns the lastRewardTime EncryptedPlayerPrefs key depending on instanceId
        ...
        //Returns the advanced debug time EncryptedPlayerPrefs key depending on instanceId
        ...
        public void Reset()
        {
            EncryptedPlayerPrefs.DeleteKey(GetLastRewardKey());
            EncryptedPlayerPrefs.DeleteKey(GetLastRewardTimeKey());
            EncryptedPlayerPrefs.DeleteKey(GetDebugTimeKey());
        }
    }
}