...
public class Advertisements : MonoBehaviour
{
    ...
    private bool callHasBeenSentToShowBanner;
    ...
    public void ShowInterstitialOfSelectedAdvertiser(SupportedAdvertisers selectedAdvertiser, UnityAction InterstitialClosed = null)
    {
        //if ads are disabled by user -> do nothing
        if (CanShowAds() == false)
        {
        ...
        {
            if (interstitialAdvertisers[i].advertiser == selectedAdvertiser)
            {
                interstitialAdvertisers[i].advertiserScript.ShowInterstitial(InterstitialClosed);
                return;
            }
        }
    }
    ...
    public void ShowRewardedVideoOfSelectedAdvertiser(UnityAction<bool> CompleteMethod, SupportedAdvertisers selectedAdvertiser)
    {
        for (int i = 0; i < rewardedAdvertisers.Count; i++)
        {
            if (rewardedAdvertisers[i].advertiser == selectedAdvertiser)
            {
                rewardedAdvertisers[i].advertiserScript.ShowRewardVideo(CompleteMethod);
            }
        }
    }
    ...
    public void ShowBanner(BannerPosition position, BannerType bannerType = BannerType.SmartBanner)
    {
        ...
        callHasBeenSentToShowBanner = true;
        hideBanners = false;
    ...
    private void BannerDisplayedResult(bool succesfullyDisplayed, BannerPosition position, BannerType bannerType)
    {
        ...
        {
            callHasBeenSentToShowBanner = false;
    ...
    {
        return callHasBeenSentToShowBanner;
    }
    ...
    public bool IsRewardVideoAvailableOfSelectedAdvertiser(SupportedAdvertisers selectedAdvertiser)
    {
        for (int i = 0; i < rewardedAdvertisers.Count; i++)
        {
            if (rewardedAdvertisers[i].advertiser == selectedAdvertiser)
    ...
    public bool IsInterstitialVideoAvailableOfSelectedAdvertiser(SupportedAdvertisers selectedAdvertiser)
    {
        for (int i = 0; i < interstitialAdvertisers.Count; i++)
        {
            if (interstitialAdvertisers[i].advertiser == selectedAdvertiser)
